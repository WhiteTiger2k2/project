...
<head>
    ...
    <!--===============================================================================================-->	
        <link rel="stylesheet" type="text/css" href="{{asset('js/vendor/daterangepicker/daterangepicker.css')}}">
        <!--===============================================================================================-->
	    <link rel="stylesheet" type="text/css" href="{{asset('js/vendor/MagnificPopup/magnific-popup.cs')}}">
    ...
    <!--===============================================================================================-->
        <link rel="stylesheet" type="text/css" href="{{asset('js/vendor/perfect-scrollbar/perfect-scrollbar.css')}}">
            ...
            <div class="container col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="row">
                    <div id="main" class="col-lg-12 col-md-12 col-sm-12">
                        <!--	cart	-->
                        @include('session/product/product')
                        <!--	End cart	-->
                    </div>
                </div>
            </div>
...
<script src="{{asset('lib/easing/easing.min.js')}}"></script>
 ...
 <script src="{{asset('js/main.4.3.1.js')}}"></script>
 ...
 <!--===============================================================================================-->
     <script src="{{asset('js/vendor/parallax100/parallax100.js')}}"></script>
     <script>
         $('.parallax100').parallax100();
     </script>
 <!--===============================================================================================-->
     <script src="{{asset('js/vendor/MagnificPopup/jquery.magnific-popup.min.js')}}"></script>
     <script>
